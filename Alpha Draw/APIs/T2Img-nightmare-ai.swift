 ...
 *  @return: Void
 */
func fetchNightmareInitialRequest(completion: @escaping (NightmareData) -> Void, bodyRequest: NightmareBodyReuqest) {
 ...
 *  @return: Void
 */
func fetchNightmareByPredictionId(completion: @escaping (NightmareData) -> Void, predictionId: String) {
